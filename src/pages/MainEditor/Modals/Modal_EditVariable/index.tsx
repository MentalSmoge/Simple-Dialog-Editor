  ...
  return (
    <Modal
        ...
        >
          ...
          <p className='p'>New Name</p>
          <input autoFocus className="input" value={EditModalVariableStore.currentNewName} onChange={e => EditModalVariableStore.changeName(e.target.value)} />
